...
$groups = [
  [
    ...
    'items' => [
      ...
      /* 旧 teraumi.com への外部リンクだったカードを、統合により内部リンクへ変更（v0255）。
         表記は「サービス内容 → ブランド名」の順。カードの位置・枚数は変えない。 */
      ['title'=>'寺院納骨＋海洋散骨（teraumi）', 'href'=>'/teraumi/', 'img'=>'/assets/img/plan-goudou.jpg', 'desc'=>'ご遺骨の一部を提携する寺院・神社に納め、残りを海へ散骨する方法です。粉骨したご遺骨をお分けし、一部は納骨堂へ、残りは海へお還しします。管理費はかからず、宗教・宗派も問いません。提携先は11都府県・28か所です。', 'cta'=>'詳しく見る'],
