...
<link rel="alternate" hreflang="ja" href="https://en1150.co.jp/">
<link rel="alternate" hreflang="en" href="https://en1150.co.jp/en/">
<link rel="alternate" hreflang="x-default" href="https://en1150.co.jp/">
...
.nav-dd-menu .nav-dd-child { padding-left: 34px; font-size: 0.8rem; color: #4a6b70 !important; }
.nav-dd-menu .nav-dd-child::before { content: '└ '; opacity: 0.55; }
...
.hero-chips { display: flex; flex-wrap: wrap; gap: 8px; list-style: none; margin: 4px 0 0; padding: 0; } /* v0253：FVのCTA削除に伴い、補足文との間隔を詰める */
...
/* .hero-ctas は v0253 でFVから撤去済み（下層ページ・他テンプレートでの再利用に備えて定義だけ残す） */
...
.footer-nav-col li.footer-sub { margin-left: 12px; }
.footer-nav-col li.footer-sub a::before { content: '└ '; opacity: 0.55; }
...
<header class="header" role="banner"><div class="header-inner">
  ...
  <nav class="header-nav" role="navigation" aria-label="メインナビゲーション">
    ...
    <a href="/about/">縁とは</a><span class="nav-dd"><a href="/service/">サービス一覧<span class="nav-dd-caret" aria-hidden="true">▾</span></a><span class="nav-dd-menu"><a href="/service/" class="nav-dd-top">サービス一覧を見る</a><a href="/kaiyou-sou/">海洋葬（海洋散骨）</a><a href="/kaiyou-sou/" class="nav-dd-child">鹿児島・錦江湾</a><a href="/kaiyou-sou/fukuoka/" class="nav-dd-child">福岡・博多湾</a><a href="/powder-cleaning/">粉骨・洗骨</a><a href="/grave/">お墓じまい</a><a href="/grave/" class="nav-dd-child">鹿児島・墓じまい</a><a href="/grave/fukuoka/" class="nav-dd-child">福岡・墓じまい</a><a href="/teien-sou/">樹木葬</a><a href="/temoto-kuyou/">お手元供養</a><a href="/jewelry-reform/">JEWELRYリフォーム</a><a href="/pet-kaiyou-sou/">ペット供養</a><a href="/ihinseiri/">遺品整理</a><a href="/hikkoshi/">お墓のお引越し</a><a href="/seizen/">海洋散骨 生前契約</a><a href="/area/">対応エリア</a></span></span><span class="nav-dd"><a href="/shindan/">供養の選び方<span class="nav-dd-caret" aria-hidden="true">▾</span></a><span class="nav-dd-menu"><a href="/shindan/" class="nav-dd-top">供養の選び方（かんたん診断）</a><a href="/onayami/">供養のお悩み解決</a><a href="/gokuyou/">よくあるご質問</a><a href="/glossary/">供養用語辞典</a></span></span><a href="/voice/">お客様の声</a><a href="/blog/">終活と供養の話</a><a href="/gokuyou/">よくある質問</a><a href="/staff/">スタッフ紹介</a>
...
<section class="hero"><div class="hero-bg"><?php foreach ([1,2,3,4] as $hs_i): ?><div class="hero-slide<?= $hs_i === 1 ? ' on' : '' ?>" style="background-image:url('/assets/img/top/slide-<?= $hs_i ?>.jpg?v=<?= h(asset_ver()) ?>')"></div><?php endforeach; ?><div class="hero-veil"></div></div><div class="hero-wave-lines" aria-hidden="true"><svg viewBox="0 0 1440 70" preserveAspectRatio="none" fill="none"><path d="M0,38 C240,10 480,58 720,34 C960,12 1200,54 1440,30" stroke="#ffffff" stroke-opacity="0.55" stroke-width="1.4"/><path d="M0,52 C240,26 480,72 720,48 C960,26 1200,66 1440,44" stroke="#d0b78f" stroke-opacity="0.5" stroke-width="1.2"/></svg></div><div class="hero-inner">
  <div class="hero-content">
    ...
    <?php /* v0253：PCのFVから「無料相談・資料請求」「LINEで気軽に相談」の2CTAを削除。
             PCのCTA導線はヘッダー右上の「資料請求・ご相談」と右側固定タブ・各セクション末尾に集約する。
             （SPでは v0230 から .hero-ctas を display:none にしていたため、この削除はPCのみに効く） */ ?>
...
<footer class="footer" role="contentinfo"><svg class="wave-top" viewBox="0 0 1440 48" preserveAspectRatio="none" aria-hidden="true"><path class="wave-fill" d="M0,26 C180,4 360,4 540,24 C720,44 900,44 1080,24 C1260,6 1380,14 1440,22 L1440,48 L0,48 Z"/></svg><div class="container">
  <div class="footer-inner">
    ...
    <div class="footer-nav-grid">
      <div class="footer-nav-col"><h4>サービス</h4><ul><li><a href="/kaiyou-sou/">海洋葬（海洋散骨）</a></li><li class="footer-sub"><a href="/kaiyou-sou/fukuoka/">福岡・海洋葬</a></li><li><a href="/seizen/">海洋散骨 生前契約</a></li><li><a href="/teien-sou/">樹木葬</a></li><li><a href="/powder-cleaning/">粉骨・洗骨</a></li><li><a href="/temoto-kuyou/">お手元供養</a></li><li><a href="/jewelry-reform/">JEWELRYリフォーム</a></li></ul></div>
      <div class="footer-nav-col"><h4>お墓のお悩み</h4><ul><li><a href="/grave/">お墓じまい</a></li><li class="footer-sub"><a href="/grave/fukuoka/">福岡・墓じまい</a></li><li><a href="/hikkoshi/">お墓の引越し（改葬）</a></li><li><a href="/pet-kaiyou-sou/">ペット供養</a></li><li><a href="/ihinseiri/">遺品整理</a></li><li><a href="/shindan/">供養の選び方（かんたん診断）</a></li><li><a href="/onayami/">供養のお悩み解決</a></li></ul></div>
