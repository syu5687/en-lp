...
// title は検索語（粉骨）と価格を前に出す。GSCで粉骨系クエリは3ヶ月586表示あるが
// クリックが伸びていないため、金額と「郵送」を見出しの位置で見せる。
$page_title     = '粉骨 24,200円〜｜ご遺骨のパウダー化・洗骨は郵送で全国対応｜縁';
$page_desc      = '粉骨（ご遺骨のパウダー化）24,200円〜、洗骨27,500円〜。いずれも税込で、あとから追加料金はいただきません。乳鉢で一件ずつ手作業、六価クロムの検査と無害化まで標準実施します。カビや湿気で傷んだご遺骨の洗浄・乾燥、真空パック・桐箱でのお返しにも対応。ご遺骨はゆうパックの郵送でお預かりでき、全国どこからでもご依頼いただけます。鹿児島・福岡はお持ち込みも可能です。';
