...
$cases = [
  ...
  [
    /* v0257：teraumi統合にともない追加。「散骨すると手を合わせる場所がなくなる」という論法は使わず、
       分け方の選択肢として提示する。海洋散骨そのものの価値は下げない。 */
    'cat' => 'ご遺骨の分け方', 'title' => 'すべてを散骨するか、一部を残すか決められない',
    'answer' => 'ご遺骨は、すべてを撒かなければならないものではありません。粉骨のときにご希望の分だけお分けできます。残した分は、ご自宅のミニ骨壷やメモリアルジュエリーにするほか、提携する寺院・神社の合祀墓へ納めることもできます（寺院納骨＋海洋散骨・270,000円 税込）。お持ち込みのお手元供養品へのご納骨は分骨費用5,500円（税込）です。分ける量は粉骨の時点で決められますので、今すぐ結論を出す必要はありません。',
    'links' => [['お手元供養', '/temoto-kuyou/'], ['寺院納骨＋海洋散骨（teraumi）', '/teraumi/'], ['粉骨・洗骨', '/powder-cleaning/']],
  ],
  [
