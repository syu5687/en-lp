...
(function(){
  ...
  var SV = {
    ...
    /* v0257：旧 teraumi.com の統合にともない追加 */
    'teraumi':         {name:'寺院納骨＋海洋散骨（teraumi）', href:'/teraumi/', s:'一部を提携寺院・神社へ／270,000円（税込）・管理費不要', cat:'teraumi'}
  };
  ...
  var TREE = {
    ...
    /* v0257：一部を残す「置き場所」は自宅・身につける・お寺／神社の3つ。
       質問は増やさず、既存の t1 に選択肢を1つ足すだけにしている。 */
    t1:{q:'手元に残す形は、どれが近いですか？',opts:[
      {b:'ミニ骨壷などで、自宅に置きたい',s:'',res:'temoto'},
      {b:'指輪やペンダントで、身につけたい',s:'',res:'jewelry'},
      {b:'お寺や神社に納めたい',s:'提携先の合祀墓へ・宗教宗派不問',region:true,res:'kaiyou-teraumi'},
  ...
  var RES = {
    ...
    /* v0257：teraumi統合にともない追加。海洋散骨そのものを弱く見せる書き方はしない。
       270,000円が合わない方の逃げ道（59,950円〜）を care に必ず入れる。 */
    'kaiyou-teraumi':{
      name:'海洋散骨 ＋ 一部を寺院・神社へ納骨（teraumi）',
      why:'大部分のご遺骨を海へお還しし、一部を提携する寺院・神社の合祀墓へ納める組み合わせです。粉骨・納骨・委託海洋葬・証明書の発行までを同じ窓口で承ります。年間管理費はかからず、宗教・宗派も問いません。270,000円（税込）で、提携先は11都府県・28か所です。',
      fit:['ご遺骨の一部を、お寺や神社にも納めたい方','檀家にならず、年間管理費もかけたくない方'],
      care:'納めたご遺骨は7年〜の個別供養ののち合祀され、あとから取り出すことはできません。「いつか手元に戻すかもしれない」場合や、ご予算を抑えたい場合は、委託海洋葬 54,450円〜 ＋ 分骨 5,500円（税込）で 59,950円〜 という、一部をご自宅に残す形もあります。',
      main:['teraumi','kaiyou-sou'], rel:['powder-cleaning','temoto-kuyou']},
    'grave-teien':{
      name:'お墓じまい ＋ 樹木葬・永代供養',
