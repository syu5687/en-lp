...
$main = ['/' => '1.0'];
$high = ['/en/', '/en/sea-burial-japan/', '/teraumi/', '/kaiyou-sou/', '/kaiyou-sou/fukuoka/', '/fukuoka/', '/grave/', '/grave/fukuoka/', '/grave/sankotsu/', '/powder-cleaning/', '/seizen/', '/service/', '/temoto-kuyou/', '/pet-kaiyou-sou/'];
