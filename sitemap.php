...
$main = ['/' => '1.0'];
$high = ['/en/', '/kaiyou-sou/', '/fukuoka/', '/grave/', '/grave/fukuoka/', '/powder-cleaning/', '/seizen/', '/service/', '/temoto-kuyou/', '/pet-kaiyou-sou/'];
$paths = ['/en/', '/grave/fukuoka/', '/service/','/shindan/','/kuyou/','/gokuyou/','/staff/','/voice/','/blog/','/company/','/contact/','/privacy/','/seizen/','/area/','/about/','/onayami/','/flow/','/fukuoka/','/policy/','/glossary/'];
