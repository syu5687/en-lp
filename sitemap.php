...
$main = ['/' => '1.0'];
$high = ['/kaiyou-sou/', '/fukuoka/', '/grave/', '/powder-cleaning/', '/seizen/', '/service/', '/temoto-kuyou/', '/pet-kaiyou-sou/'];
$paths = ['/service/','/shindan/','/kuyou/','/gokuyou/','/staff/','/voice/','/blog/','/company/','/contact/','/privacy/','/seizen/','/area/','/about/','/onayami/','/flow/','/fukuoka/','/policy/','/glossary/'];
