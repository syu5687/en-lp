...
$gl_sections = [
  ...
  ['id' => 'funkotsu', 'title' => '粉骨・ご遺骨の用語', 'terms' => [
    ...
    ['id' => 'rokka-chrome', 'name' => '六価クロム', 'desc' => '火葬炉の耐熱ステンレスなどに含まれるクロムが火葬の高温で酸化してできる有害物質（発がん性物質）。ご遺骨に付着していることがあり、散骨や手元供養の前に検査キットで確認し、還元剤で無害化するのが望ましい。当社は2019年から検査・無害化処理を実施。', 'link' => '/powder-cleaning/'],
...
$page_title     = '供養用語辞典｜散骨・墓じまい・粉骨のことば38語をやさしく解説｜' . SITE['name'];
$page_desc      = '海洋散骨・墓じまい・粉骨・終活の用語38語を、鹿児島の供養専門会社がやさしく解説。改葬許可・離檀料・閉眼供養・カロート・分骨・永代供養・合祀など、ご供養の検討で出てくる言葉の意味がわかる辞典ページです。';
...
<main class="section">
  <div class="container" style="max-width:860px">
    <p class="lead" style="margin-bottom:10px">ご供養の検討を始めると、聞き慣れない言葉が次々に出てきます。このページでは、海洋散骨・墓じまい・粉骨・終活にまつわる<strong>38語</strong>を、鹿児島で20年以上ご遺骨と向き合ってきた縁（えん）がやさしく解説します。</p>
