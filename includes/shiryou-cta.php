...
<section class="shiryou-cta" aria-labelledby="shiryou-title">
  <div class="shiryou-cta__inner">
    ...
    <p class="shiryou-cta__lead">検討中の方のための資料を2冊ご用意しました。フォームからご請求いただくと、<strong>詳しい資料を郵送でお届け</strong>します。お急ぎの方は<strong>PDF版をメールで今すぐ</strong>受け取ることもできます（いずれも無料・こちらから営業のご連絡はいたしません）。</p>
